    ...
    <div>
            ...
            <div className="container">
              <div className="ptboutr">
                ...
                <ol className="breadcrumb">
                  ...
                  <li>
                    <a aria-label="" href="/">{t("header.home")}</a>
                  </li>
                  <li>
                    <a aria-label="" href="/">{t("notfound.ErrorPage")}</a>
                  </li>
                </ol>
              </div>
            </div>
      ...
      <div className="error-container">
        <div className="error-content">
          ...
          <a href="/" onClick={handleReload} className="error-link">{t("notfound.back-home-error")}</a>
        </div>
      </div>
    </div>
  );
